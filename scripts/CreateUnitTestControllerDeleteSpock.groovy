...
target( createUnitTestControllerDeleteSpock:
    "Generate Spock unit tests for 'delete' controller method" ) {
    ...
    def msg = "Finished generation of Spock 'delete' controller unit tests"
    event( 'StatusFinal', [ msg ] )

}// End of closure

setDefaultTarget( createUnitTestControllerDeleteSpock )
...
String generateRequestMethodInvalidMethod( className, idName ) {
    ...
    content << "${TAB*3}controller.delete()\n"
    content << "${TAB*2}then:\n"
