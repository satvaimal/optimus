...
void generate( domainClass ) {
    ...
    content << this.generatePointcutMethod( domainClass, idAssigned )
    content << this.generateBeforeMethod( idAssigned )
    content << this.generateAfterReturningMethod( domainClass.name, idAssigned )
    content << this.generateAfterThrowingMethod( idAssigned )
    content << '}'
